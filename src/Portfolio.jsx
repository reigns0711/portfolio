// Paste your Portfolio component code here from ChatGPT.
import React, { useState } from 'react';
import { Menu, X, Mail, Phone, MapPin, Github, Linkedin, ExternalLink } from 'lucide-react';

export default function Portfolio() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  const skills = [
    'React', 'Redux', 'HTML', 'CSS', 'JavaScript', 'Node.js', 
    'Express.js', 'MongoDB', 'Mongoose', 'Next.js', 'Tailwind', 
  ...
  const experiences = [
    {
      ...
      description: 'A company specializing in software development across various platforms',
      achievements: [
    ...
    },
    {
      ...
      description: 'A technology solutions company focusing on web application development',
      achievements: [
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg text-slate-400 max-w-3xl mx-auto mb-8">
              5.8+ years of experience in front-end and full-stack development, specializing in the MERN stack. 
              Excelling in creating responsive web applications, handling product development and team leadership.
            </p>
            <div className="flex justify-center gap-4 flex-wrap">
              <a href="mailto:lokeshjk.mit@gmail.com" className="flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 px-6 py-3 rounded-lg transition-colors">
                <Mail size={20} />
                Get in Touch
              </a>
              <button 
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-700/50 p-8 rounded-xl">
              ...
              <p className="text-slate-300 leading-relaxed">
                I am a Senior Software Developer with extensive experience in building scalable web applications 
                using the MERN stack. My expertise spans across various frameworks including React.js, Next.js, 
                Node.js, and MongoDB, with a strong ability to deliver high-quality software solutions.
              </p>
            </div>
            <div className="bg-slate-700/50 p-8 rounded-xl">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <div key={index} className="bg-slate-800/50 p-8 rounded-xl border border-slate-700 hover:border-cyan-400/50 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700">
              <h3 className="text-2xl font-semibold text-cyan-400 mb-2">B.E. (ECE)</h3>
              <p className="text-xl text-slate-300 mb-2">Jeppair Maamallan Institute of Technology</p>
              <p className="text-slate-400">08/2012 - 05/2016</p>
            </div>
            <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700">
              <h3 className="text-2xl font-semibold text-cyan-400 mb-2">HSC</h3>
              <p className="text-xl text-slate-300 mb-2">Anderson Matriculation Higher Secondary School</p>
